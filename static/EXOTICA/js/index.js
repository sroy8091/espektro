var Fireworks = function(){
    ...
    self.dt = 0;
		...
		self.canvas.onselectstart = function() {
         ...
         vwidth=w.innerWidth||e.clientWidth||g.clientWidth,
         vheight=w.innerHeight||e.clientHeight||g.clientHeight;
		
		self.canvas.width = self.cw = vwidth;
		self.canvas.height = self.ch = vheight;
